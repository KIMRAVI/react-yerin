...
const rows = [
  ...
  { screenName: "ColorsGuide", path: "/guides/colors" },
  { screenName: "IconsGuide", path: "/guides/icon" },
  { screenName: "ModalGuide", path: "/guides/modal" },
];

export default function BasicTable() {
  return (
    <TableContainer component={Paper} sx={{ mt: 2 }} className={styles.wrapper}>
